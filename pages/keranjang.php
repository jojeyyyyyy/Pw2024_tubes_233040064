    ...
    <nav class="navbar navbar-expand-lg navbar-light navbar-dark bg-dark">
        <div class="container-fluid">
            <div class="service-icon">
                    ...
                    <span class="text-white"> King <strong >Sport</strong></span>
                </div>
                ...
                <table class="table">
                    ...
                    <tbody class="align-middle">
                        <tr> -->
                            ...
                            <td>VELG</td>
                            <td><img src="../assets/pelak2.jpeg" class="img-keranjang"></td>
                            <td>Rp. 1.000.000</td>
                        ...
                        <tr>
                            ...
                            <td>Master Rem</td>
                            <td><img src="../assets/master rem.png_.webp" class="img-keranjang"></td>
                            <td>Rp. 500.000</td> 
                            <td> <button class="button btn-dark btn-sm">-<i class="fas fa-minus"></i></button>
                                <span class="mx-2">1</span>
                                <button class="button btn-dark btn-sm">+<i class="fas fa-plus"></i></button>
                        ...
                        <tr>
                            ...
                            <td>KANALPOT</td>
                            <td><img src="../assets/kanalpot.jpg" class="img-keranjang"></td>
                            <td>Rp. 750.000</td> 
                            <td> <button class="button btn-dark btn-sm">-<i class="fas fa-minus"></i></button>
                                <span class="mx-2">1</span>
                                <button class="button btn-dark btn-sm">+<i class="fas fa-plus"></i></button>
