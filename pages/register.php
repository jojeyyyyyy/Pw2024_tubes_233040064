                ...
                <div class="col-md-7">
                    <div class="mb-3">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="textl" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Nama Lengkap">
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-md-7">
                        <div class="mb-3">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="textl" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="E-mail">
                            </div>
                        </div>
                    </div>
